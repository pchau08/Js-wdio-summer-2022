...
class Homepage {
    ...
    loginErrorMsg = '//div[@class="_9ay7"]';
    messengerPage = '//a[contains(text(),"Messenger")]';
    ...
    async getTextLoginError() {
        await this.commands.getTextFromWebElement(this.loginErrorMsg)
        return (this.loginErrorMsg);
    }

    async clickMessenger() {
        await this.commands.clickWebElement(this.messengerPage)
    }
